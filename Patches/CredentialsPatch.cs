...
using CrewmateOrImpostor.Templates;
...
namespace CrewmateOrImpostor
{
    ...
    {
        public static SpriteRenderer CrewmateOrImpostorLogo { get; private set; }
        ...
        class VersionShowerStartPatch
        {
            ...
            static void Postfix(VersionShower __instance)
            {
                ...
                var credentials = TMPTemplate.Create(
                    "CrewmateOrImpostorCredentialsText",
                    Main.credentialsText,
                    fontSize: 2f,
                ...
                if (SpecialEventText == null && CrewmateOrImpostorLogo != null)
                {
                    SpecialEventText = TMPTemplate.Create(
                        ...
                        parent: CrewmateOrImpostorLogo.transform);
        ...
        class TitleLogoPatch
        {
            ...
            static void Postfix(MainMenuManager __instance)
            {
                ...
                var logoObject = new GameObject("titleLogo_CrewmateOrImpostor");
                var logoTransform = logoObject.transform;
                CrewmateOrImpostorLogo = logoObject.AddComponent<SpriteRenderer>();
                logoTransform.parent = rightpanel;
                logoTransform.localPosition = new(0f, 0.15f, 1f);
                logoTransform.localScale *= 1.2f;
                CrewmateOrImpostorLogo.sprite = Utils.LoadSprite("CrewmateOrImpostor.Resources.CrewmateOrImpostor-Logo.png", 300f);
            }
        }
