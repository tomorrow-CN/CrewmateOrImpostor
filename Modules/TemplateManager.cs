...
namespace CrewmateOrImpostor
{
    ...
    {
        private static readonly string TEMPLATE_FILE_PATH = "./CrewmateOrImpostor_DATA/template.txt";
        ...
        public static void CreateIfNotExists()
        {
            if (!File.Exists(TEMPLATE_FILE_PATH))
            {
                try
                {
                    if (!Directory.Exists(@"CrewmateOrImpostor_DATA")) Directory.CreateDirectory(@"CrewmateOrImpostor_DATA");
