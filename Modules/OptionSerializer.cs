...
public static class OptionSerializer
{
    ...
    private const string Header = "%CrewmateOrImpostorOptions%", Footer = "%End%";
    private static readonly DirectoryInfo exportDir = new("./CrewmateOrImpostor_DATA/OptionOutputs");
