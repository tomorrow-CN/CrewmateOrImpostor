...
namespace CrewmateOrImpostor
{
    ...
    {
        private static readonly string DENY_NAME_LIST_PATH = @"./CrewmateOrImpostor_DATA/DenyName.txt";
        private static readonly string BAN_LIST_PATH = @"./CrewmateOrImpostor_DATA/BanList.txt";

        [PluginModuleInitializer]
        public static void Init()
        {
            Directory.CreateDirectory("CrewmateOrImpostor_DATA");
