...
namespace CrewmateOrImpostor.Modules.ClientOptions;
        ...
        OptionsMenuBehaviour optionsMenuBehaviour)
    {
        try
        {
            ...
            if (CustomBackground == null)
            {
                ...
                ModOptionsButton.name = "CrewmateOrImpostorOptions";
                ModOptionsButton.Text.text = Translator.GetString("CrewmateOrImpostorOptions");
